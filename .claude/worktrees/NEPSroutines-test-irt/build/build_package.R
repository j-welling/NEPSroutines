...
devtools::document(pkg = "./NEPSroutines")

# Installieren des Pakets
devtools::install(pkg = "./NEPSroutines")
...
devtools::check(pkg = "NEPSroutines", args = c('--as-cran'))

# Erstellen des tar.gz-Verzeichnisses
pkgbuild::build(path = "./NEPSroutines", dest_path = ".")
