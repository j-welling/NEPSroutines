...
---
title: "Scaling study  B129 (Reading) with the NEPSroutines package"
author: "Jana Welling"
date: "`r Sys.time()`"
output:
    html_document:
...
#pkgload::load_all('Z:/Projektgruppen_(08)/Kompetenzen_BA_Hiwi_(p000012)/Methoden/Skalierung/Skalierungspaket/NEPSroutines')
```
...
NEPSroutines::sample_by_group(
  ...
  save = TRUE,
  overwrite = TRUE,
  path = 'Test/B129/Version 1.2.0/Tables'
)
...
NEPSroutines::mv_person(
  ...
  save = TRUE,
  return = FALSE,
  path_results = 'Test/B129/Version 1.2.0/Results',
  path_table = 'Test/B129/Version 1.2.0/Tables',
  path_plots = 'Test/B129/Version 1.2.0/Plots/Missing_Responses/by_person',
  show_all = TRUE,
  overwrite = TRUE,
  warn = TRUE,
  verbose = FALSE
...
NEPSroutines::mv_item(
  ...
  path_results = 'Test/B129/Version 1.2.0/Results',
  path_table = 'Test/B129/Version 1.2.0/Tables',
  path_plots = 'Test/B129/Version 1.2.0/Plots/Missing_Responses/by_item',
  show_all = TRUE,
  overwrite = TRUE,
  warn = TRUE,
  verbose = FALSE
...
```{r IRT analysis}
irt_dich <- NEPSroutines::irt_analysis(
  resp = resp,
  vars = vars,
  select = 'dich',
  valid = 'valid',
...
irt_dich_fixed <- NEPSroutines::irt_analysis(
  resp = resp,
  vars = vars,
  select = 'dich',
  valid = 'valid',
...
irt_poly <- NEPSroutines::irt_analysis(
  resp = resp,
  vars = vars,
  select = 'mixed',
  valid = 'valid',
...
irt_poly_fixed <- NEPSroutines::irt_analysis(
  resp = resp,
  vars = vars,
  select = 'mixed',
  valid = 'valid',
...
irt_grouped <- NEPSroutines::grouped_irt_analysis(
...
NEPSroutines::irt_analysis(
  ...
  path_results = 'Test/B129/Version 1.2.0/Results',
  path_table = 'Test/B129/Version 1.2.0/Tables',
  path_plots = 'Test/B129/Version 1.2.0/Plots',
  overwrite = TRUE,
  verbose = FALSE,
  name_group = 'all'
)
...
NEPSroutines::create_suf(
  ...
  mvs = NULL,
  items_labels = NULL,
  path = 'Test/B129/Version 1.2.0/SUF',
  save = TRUE,
  return = FALSE,
  warn = TRUE
)
