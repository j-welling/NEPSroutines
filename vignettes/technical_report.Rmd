...
Please note when opening a word document created with `scaling` word may ask to "restore hidden content of the document" or "update fields" in the document. If so, these questions should be confirmed to automatically set some information (e.g., in the page headings) in the word document.
