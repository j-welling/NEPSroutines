...
scaling_package <- # here define name of newest version of scaling package (as string)
install.packages(paste0(path_project, scaling_package), type='source', repos=NULL)
library('scaling')
```
...
```{r suf}
scaling::suf <- scaling::create_suf(
  resp = resp,
  vars = vars,
  select = 'suf',
  competence = 'reading',
