...
# The names of `rownames` must match the dimensions in your own data: "dim1",
# "dim2", ... for a numerically coded variable, otherwise its factor levels.
# They determine both the labels and the row and column order of the table.
