...
set_labels <- function(suf, vars, select, competence, score_name = NULL,
  ...
  for (i in scores) {
    ...
    lbl <- switch(type,
                  "_sc1" = "WLE (korrigiert)",
                  "_sc2" = "Standardfehler des WLE (korrigiert)",
                  "_sc1a" = "WLE (korrigiert)",
                  "_sc2a" = "Standardfehler des WLE (korrigiert)",
                  "_sc1b" = "WLE (korrigiert)",
                  "_sc2b" = "Standardfehler des WLE (korrigiert)",
                  "_sc1u" = "WLE (unkorrigiert)",
                  "_sc2u" = "Standardfehler des WLE (unkorrigiert)",
                  "_sc3" = "Summe",
                  "_sc3a" = "Summe",
                  "_sc3b" = "Summe",
                  "_sc4" = "Mittelwert",
                  ...
                  "_sc7" = "Person in L1-Zielpopulation"
    )
    if (is.null(lbl)) next
