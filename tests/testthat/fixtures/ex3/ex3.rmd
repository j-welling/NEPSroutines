...
NEPSroutines::desc_nom(resp, desc = c("sex", "mig", "rotation"), valid = "valid")
NEPSroutines::show_attributes(resp, desc = c("sex", "mig", "rotation"))
...
scores <- NEPSroutines::create_scores(
  ...
  valid = "valid",
  scoring = "scoring",
  #facet = "rotation", # does not work in current version of NEPSroutines
  num_cat = "num_cat",
  mvs = mvs,
  sum_select = "dich",
  wle = TRUE,
